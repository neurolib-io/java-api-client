...
import com.neurolib.api_client.exceptions.*;
...
class NeurolibTestCase {
    protected NeurolibClient client;

    public NeurolibTestCase() {
        client =  new NeurolibClient("client-test", "jGGQ6ZKa8rQ1zTAyxTc0EMn55YPF7FJLUtaMLhbsGxmvwxgTwXYqmUk5xVZFw98L");
    }
